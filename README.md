GIT (Pasos para Subir al Repositorio)
Paso 1: git add .
Paso 2: git commit -m "Los Cambios que se Hicieron"
Paso 3: git push
...
4.1 Activamos el Entorno Virtual con '. .venv/bin/activate'
4.2 Para Desactivar el Entorno Virtual directamente escribimos "deactivate"
